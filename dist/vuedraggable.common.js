...
module.exports = require("better-sortable");
...
// EXTERNAL MODULE: external {"commonjs":"better-sortable","commonjs2":"better-sortable","amd":"better-sortable","root":"better-sortable"}
var external_commonjs_better_sortable_commonjs2_better_sortable_amd_better_sortable_root_better_sortable_ = __webpack_require__("4f34");
var external_commonjs_better_sortable_commonjs2_better_sortable_amd_better_sortable_root_better_sortable_default = /*#__PURE__*/__webpack_require__.n(external_commonjs_better_sortable_commonjs2_better_sortable_amd_better_sortable_root_better_sortable_);

// CONCATENATED MODULE: ./node_modules/better-sortable/modular/sortable.core.esm.js
/**!
 * Sortable 1.14.0
...
let pluginEvent = function (eventName, sortable, {
  ...
  PluginManager.pluginEvent.bind(Sortable)(eventName, sortable, {
    ...
    cloneEl,
    cloneHidden,
    dragStarted: sortable_core_esm_moved,
    putSortable,
...
/** @lends Sortable.prototype */
{
  ...
  evt) {
    ...
    if (evt) {
      ...
      if (dragEl) {
        ...
        if (sortable_core_esm_moved && !awaitingDragStarted) {
  ...
  _nulling: function () {
    ...
    rootEl = dragEl = parentEl = ghostEl = nextEl = cloneEl = lastDownEl = cloneHidden = tapEvt = touchEvt = sortable_core_esm_moved = sortable_core_esm_newIndex = newDraggableIndex = sortable_core_esm_oldIndex = oldDraggableIndex = lastTarget = lastDirection = putSortable = activeGroup = Sortable.dragged = Sortable.ghost = Sortable.clone = Sortable.active = null;
...
external_commonjs_better_sortable_commonjs2_better_sortable_amd_better_sortable_root_better_sortable_default.a.mount(new SwapPlugin());
...
var draggableComponent = {
  ...
  mounted: function mounted() {
    ...
    this._sortable = new external_commonjs_better_sortable_commonjs2_better_sortable_amd_better_sortable_root_better_sortable_default.a(this.rootContainer, options);
    this.computeIndexes();
  },
  ...
  methods: {
    ...
    swapPosition: function swapPosition(oldIndex, newIndex) {
      var swapPosition = function swapPosition(list) {
        return list[oldIndex] = list.splice(newIndex, 1, list[oldIndex])[0];
      };
    ...
    onDragAddSwap: function onDragAddSwap(evt) {
      var swapContext = this.getUnderlyingVm(evt.swapItem);
      evt.swapItem._underlying_vm_ = this.clone(swapContext.element);
      Object(helper["c" /* insertNodeAt */])(evt.to, evt.swapItem, evt.newIndex);
    ...
    onDragRemoveSwap: function onDragRemoveSwap(evt) {
      var oldIndex = evt.oldIndex,
          newIndex = evt.newIndex,
          from = evt.from,
          to = evt.to;
      var swapElement = evt.swapItem._underlying_vm_;
    ...
    onDragUpdateSwap: function onDragUpdateSwap(evt) {
      var oldIndex = evt.oldIndex,
          newIndex = evt.newIndex,
          from = evt.from,
          to = evt.to;
      var swapContext = this.getUnderlyingVm(evt.swapItem);
      var swapElement = this.clone(swapContext.element);
      from.replaceChild(evt.swapItem, evt.item);
      Object(helper["c" /* insertNodeAt */])(from, evt.item, oldIndex);
